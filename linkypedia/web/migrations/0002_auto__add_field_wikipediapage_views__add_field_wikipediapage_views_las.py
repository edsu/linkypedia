...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WikipediaPage.views'
        db.add_column('web_wikipediapage', 'views', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'WikipediaPage.views_last'
        db.add_column('web_wikipediapage', 'views_last', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WikipediaPage.views'
        db.delete_column('web_wikipediapage', 'views')

        # Deleting field 'WikipediaPage.views_last'
        db.delete_column('web_wikipediapage', 'views_last')
    ...
    models = {
        ...
        'web.wikipediapage': {
            ...
            'views': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
